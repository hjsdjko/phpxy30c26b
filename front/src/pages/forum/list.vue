<template>
<div class="forum-preview" :style='{"width":"86%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div :style='{"width":"100%"}'>
		<div :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"20px","height":"54px"}'>社交论坛</div>
	</div>
    <el-form :style='{"padding":"10px","margin":"10px 0","alignItems":"center","flexWrap":"wrap","background":"#ffc054","display":"flex","width":"100%","justifyContent":"center","height":"auto"}' :inline="true" :model="formSearch" class="list-form-pv">
	...
	<div class="z-box" :style='{"width":"100%","padding":"0px","margin":"30px 0 0","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"width":"100%","fontSize":"14px","lineHeight":"20px","overflow":"hidden","color":"#313131","height":"20px"}' class="item-style">{{item.title}}</div>
		  <div :style='{"width":"100%","fontSize":"14px","lineHeight":"20px","color":"#333","height":"20px"}' class="item-style">发布人：{{item.username}}</div>
		  <div :style='{"width":"100%","fontSize":"14px","lineHeight":"20px","color":"#333","height":"20px"}' class="item-style">{{item.addtime}}</div>
		</div>
	</div>

<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231201/94181f4a19bc4abf8daff5310ff35259.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","margin":"0","borderRadius":"0","background":"rgba(0,0,0,0.5)","width":"600px","position":"absolute","right":"5%","height":"850px"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"24px","color":"#E1B44F","textAlign":"center"}'>基于web的动漫插画分享网站注册</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuzhanghao">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}' :class="changeRules('yonghuzhanghao')?'required':''">用户账号：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuxingming">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}' :class="changeRules('yonghuxingming')?'required':''">用户姓名：</div>
